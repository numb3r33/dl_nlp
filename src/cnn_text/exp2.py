...
def main(exp_name, run_mode, is_sample):
    ...
    if run_mode == 'train':
        ...
        model_fp                   = os.path.join(MODEL_FP, 'word2vec.pkl')
        ...
        model     = get_exp2_model(embedding_matrix, token_to_id, exp_name, PAD_IX)
        ...
        prepare_submission(test_labels, preds, os.path.join(SUB_PATH, 'exp2_cnn_text.csv'))
